...
def custom_score(game, player):
    ...
    """
    # Define number of moves a player and opponent have available
...
def custom_score_3(game, player):
    ...
    # If my_moves is higher than opponent_moves this is seen as good
        ...
        **********************************************************************
        ...
        try:
            ...
            while True:
                ...
                depth += 1 # Keep deepening until time_left == 0
